...
class CustomBM25Retriever(BaseRetriever):
    ...
    vectorizer: Optional[BM25Okapi] = None
    """ BM25 vectorizer."""
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        Returns:
            A CustomBM25Retriever instance.
        """
        try:
            from rank_bm25 import BM25Okapi
        except ImportError:
    ...
    def _get_relevant_documents(
        ...
        return_docs = self.vectorizer.get_scores(processed_query)
        return_docs = [
            Document(
                page_content=doc.page_content,
                metadata={**doc.metadata, **{"score": score}},
            ) for doc, score in zip(self.docs, return_docs)
        ]
        return sorted(return_docs, key=lambda x: x.metadata["score"], reverse=True)[0:self.k]